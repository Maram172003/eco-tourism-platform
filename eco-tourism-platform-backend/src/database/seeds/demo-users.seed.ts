...
async function seed() {
  ...
  await circuits.save([
    ...
    },
    {
      ...
      nb_jours: 3,
      etapes: [
        { id: 'e1', jour: 1, titre: 'El Kef médina', description: 'Visite guidée' },
        { id: 'e2', jour: 2, titre: 'Villages de montagne', description: 'Rencontres locales' },
        { id: 'e3', jour: 3, titre: 'Artisanat', description: 'Atelier poterie' },
      ],
    ...
    },
    {
      ...
      nb_jours: 3,
      etapes: [
        { id: 'e1', jour: 1, titre: 'Accueil & forêt', description: 'Installation et balade' },
        { id: 'e2', jour: 2, titre: 'Observation nature', description: 'Sortie matinale' },
        { id: 'e3', jour: 3, titre: 'Départ', description: 'Petit-déjeuner et checkout' },
      ],
      hebergement: { type: 'ecolodge', name: 'Écolodge Les Chênes' },
